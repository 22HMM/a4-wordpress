...
<div class="news-events">
    ...
    <!-- <div class="container">
            <div class="row inner-nav">
                <ul class="d-flex curriculum align-items-center gap-2 my-5 " style="font-family: var(--secondary-font); font-size: 18px;">
                    <li>Home <img src="<?php echo get_template_directory_uri(); ?>/includes/a4-school/images/caret-right 1.png" alt=""></li>
                    <li>News & Events
                        <img src="<?php echo get_template_directory_uri(); ?>/includes/a4-school/images/caret-right 1.png" alt="">
                    </li>
                    </li>
                    <li>
        ...
        <div class="row" style="border-bottom: 2px solid #808080; margin-bottom: 30px;">
                ...
                <div class="col-md-8">
                    <div class="content">
                        ...
                        <div class="my-4 py-1">
                            ...
                            <div>
                                <h2 class="fw-bold content-heading" style="font-family: var(--main-font); color: var(--primary-text); font-size: 28px;">
                                    <?php the_title(); ?>
                                </h2>
                                <div class="py-2 content-para" style="font-family: var(--secondary-font); color: var(--primary-text); font-size: 16px;">
                                    <?php the_content(); ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                ...
                ?>
                        ...
                        <div class="">
                            <div class="row my-4 latest-posts align-items-center text-decoration-none">
                                ...
                                <div class="col-md-8 inner-heading col-sm-8 posts col-8">
                                    <a href="<?php echo the_permalink(); ?>" class="text-decoration-none fw-bold my-2 " style="font-family: var(--secondary-font);">
                                        <?php the_title(); ?>
                                    </a>
