...
function _tk_scripts() {
	...
	// load bootstrap css
	wp_enqueue_style( '_bootstrap', THEME_DIR_URI . '/includes/a4-School/css/bootstrap.min.css' );
	wp_enqueue_style( '_css', THEME_DIR_URI . '/includes/a4-School/css/style.css' );
	...
	// load bootstrap js
	wp_enqueue_script('_bootstrapjs', THEME_DIR_URI . '/includes/a4-School/js/bootstrap.bundle.min.js', array('jquery') );
